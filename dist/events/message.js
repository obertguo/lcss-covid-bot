        ...
        switch (_a.label) {
            case 0:
                if (message.author.bot || !message.content.toLowerCase().startsWith(botUtils.getBotConfig().prefix))
                    return [2 /*return*/];
                args = message.content.toLowerCase().split(botUtils.getBotConfig().prefix)[1].split(' ').filter(function (v) { return v !== ''; });
                cmd = args[0];
            ...
            case 3:
                ...
                message.channel.send("\u274C Command execution failed. You can report this to Kai#6119").catch(function (errr) { return utils.logError("ERR:\n" + errr); });
