...
exports.exec = function (message, args, botUtils) {
    return new Promise(function (resolve, reject) { return __awaiter(void 0, void 0, void 0, function () {
        var stats, _a, _b, embed, err_1;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _c.trys.push([0, 2, , 3]);
                    _b = (_a = JSON).parse;
                    return [4 /*yield*/, Utils.readFile('./covidstats.json')];
                case 1:
                    stats = _b.apply(_a, [_c.sent()]);
                    embed = botUtils.constructEmbed();
                    embed.addField('Ontario', "\uD83D\uDEA9 Total cases: **" + stats.ontario.totalCases.toLocaleString() + "** \n\uD83D\uDD3C Increase from previous report: **" + stats.ontario.dailyIncrease.toLocaleString() + "**", true);
                    embed.addField('London', "\uD83D\uDEA9 Total cases: **" + stats.london.totalCases.toLocaleString() + "** \n\uD83D\uDD3C Increase from previous report: **" + stats.london.dailyIncrease.toLocaleString() + "**", true);
