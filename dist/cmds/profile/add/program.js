        ...
        return [2 /*return*/, new Promise(function (resolve, reject) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, Utils.executeDBQuery('INSERT INTO `useruniversityprograms` (userID, program, programStatus) VALUES (?, ?, ?)', [message.author.id, value.split(',')[0], value.split(',')[1].trim().toLowerCase()])];
                        case 1:
                            _a.sent();
                            resolve();
                            return [3 /*break*/, 3];
