...
var Ontario = require("./Ontario");
var London = require("./London");
var utils = require("../GeneralUtils");
var getCovidStats = function () {
    return new Promise(function (resolve, reject) { return __awaiter(void 0, void 0, void 0, function () {
        var ontario, london, data, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    ontario = new Ontario(utils.createHeadlessWebDriver());
                    return [4 /*yield*/, ontario.getData()];
                case 1:
                    _a.sent();
                    london = new London(utils.createHeadlessWebDriver());
                    return [4 /*yield*/, london.getData()];
                case 2:
                    _a.sent();
                    data = {
                        ontario: {
